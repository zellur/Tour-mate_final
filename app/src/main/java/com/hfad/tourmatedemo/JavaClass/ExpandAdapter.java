...
public class ExpandAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandAdapter(Context context, List<String> listDataHeader, HashMap<String, List<String>> listHashMap) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.tourlist_group,null);
        }
